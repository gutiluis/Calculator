...
This calculator will handle addition, subtraction, multiplication, and division from the CLI.
...
- Performs the calculation using a switch.
- Prints the result.
...
* **GitHub Discussions:** [Open a discussion](https://github.com/gutiluis/Calculator/discussions)
